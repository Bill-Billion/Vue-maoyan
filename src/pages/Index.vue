...
export default {
    ...
    // filters:{
    //     active:()=>{
    //         return this.currentIndex === value ? '#f03d37' : '#696969'
    //     }
    // },
    components:{
        Home
